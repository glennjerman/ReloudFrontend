...
export function addAudio(url) {
    return fetch("http://192.168.86.77:8000/api/convert/", {
        method: "POST",
        headers: {
...
export function listAudio() {
    return fetch("http://192.168.86.77:8000/api/user/audios/", {
        method: "GET",
        headers: {
            "Content-Type": "application/json",
            Authorization: `Token ${Cookie.get("token")}`,
...
export function getAudio(id) {
    return fetch(`http://192.168.86.77:8000/api/audio/${id}/`, {
        method: "GET",
        headers: {
            "Content-Type": "application/json",
            Authorization: `Token ${Cookie.get("token")}`,
...
export function getAudioByName(name) {
    return fetch(`http://192.168.86.77:8000/api/audio/${name}/`, {
        method: "GET",
        headers: {
            "Content-Type": "application/json",
            Authorization: `Token ${Cookie.get("token")}`,
